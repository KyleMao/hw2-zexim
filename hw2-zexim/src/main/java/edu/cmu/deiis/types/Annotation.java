...
public class Annotation extends org.apache.uima.jcas.tcas.Annotation {
  ...
  *
  ...
  public String getAnnotatedText() {
    if (Annotation_Type.featOkTst && ((Annotation_Type)jcasType).casFeat_annotatedText == null)
      jcasType.jcas.throwFeatMissing("annotatedText", "edu.cmu.deiis.types.Annotation");
    return jcasType.ll_cas.ll_getStringValue(addr, ((Annotation_Type)jcasType).casFeatCode_annotatedText);}
  ...
  public void setAnnotatedText(String v) {
    if (Annotation_Type.featOkTst && ((Annotation_Type)jcasType).casFeat_annotatedText == null)
      jcasType.jcas.throwFeatMissing("annotatedText", "edu.cmu.deiis.types.Annotation");
    jcasType.ll_cas.ll_setStringValue(addr, ((Annotation_Type)jcasType).casFeatCode_annotatedText, v);}    
  }
